...
build_time_vars = {
    ...
    'CONFINCLUDEPY': '/usr/local/include/python3.13t',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/lucas/wrk/languages/cursedpython/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/lucas/wrk/languages/cursedpython/lcov-report',
    ...
    'DEEPFREEZE_DEPS': './Tools/build/deepfreeze.py Include/internal/pycore_global_strings.h _bootstrap_python ./Programs/_freeze_module.py \\',
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/usr/local/bin/python3.13t',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/usr/local/include /usr/local/include /usr/local/include/python3.13t /usr/local/include/python3.13t',
    'INCLUDEDIR': '/usr/local/include',
    'INCLUDEPY': '/usr/local/include/python3.13t',
    'INSTALL': '/usr/bin/install -c',
    'INSTALL_DATA': '/usr/bin/install -c -m 644',
    'INSTALL_PROGRAM': '/usr/bin/install -c',
    'INSTALL_SCRIPT': '/usr/bin/install -c',
    'INSTALL_SHARED': '/usr/bin/install -c -m 755',
    'INSTSONAME': 'libpython3.13t.a',
    'IO_H': 'Modules/_io/_iomodule.h',
    'IO_OBJS': '\\',
    'LDCXXSHARED': 'g++ -shared',
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13t.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -shared',
    'LDVERSION': '3.13t',
    'LIBC': '',
    ...
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LINK_PYTHON_DEPS': 'libpython3.13t.a',
    'LINK_PYTHON_OBJS': '\\',
    'LIPO_32BIT_FLAGS': '',
    'LIPO_INTEL64_FLAGS': '',
    'LLVM_PROF_ERR': 'no',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -DPy_BUILD_CORE_BUILTIN',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '',
    ...
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include',
    'PY_SUPPORT_TIER': 1,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 0,
    'Py_HASH_ALGORITHM': 0,
    ...
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313t-x86_64-linux-gnu.so Modules/_asyncio.cpython-313t-x86_64-linux-gnu.so Modules/_bisect.cpython-313t-x86_64-linux-gnu.so Modules/_contextvars.cpython-313t-x86_64-linux-gnu.so Modules/_csv.cpython-313t-x86_64-linux-gnu.so Modules/_heapq.cpython-313t-x86_64-linux-gnu.so Modules/_json.cpython-313t-x86_64-linux-gnu.so Modules/_lsprof.cpython-313t-x86_64-linux-gnu.so Modules/_opcode.cpython-313t-x86_64-linux-gnu.so Modules/_pickle.cpython-313t-x86_64-linux-gnu.so Modules/_queue.cpython-313t-x86_64-linux-gnu.so Modules/_random.cpython-313t-x86_64-linux-gnu.so Modules/_struct.cpython-313t-x86_64-linux-gnu.so Modules/_xxsubinterpreters.cpython-313t-x86_64-linux-gnu.so Modules/_xxinterpchannels.cpython-313t-x86_64-linux-gnu.so Modules/_zoneinfo.cpython-313t-x86_64-linux-gnu.so Modules/math.cpython-313t-x86_64-linux-gnu.so Modules/cmath.cpython-313t-x86_64-linux-gnu.so Modules/_statistics.cpython-313t-x86_64-linux-gnu.so Modules/_datetime.cpython-313t-x86_64-linux-gnu.so Modules/_decimal.cpython-313t-x86_64-linux-gnu.so Modules/binascii.cpython-313t-x86_64-linux-gnu.so Modules/_lzma.cpython-313t-x86_64-linux-gnu.so Modules/zlib.cpython-313t-x86_64-linux-gnu.so Modules/readline.cpython-313t-x86_64-linux-gnu.so Modules/_md5.cpython-313t-x86_64-linux-gnu.so Modules/_sha1.cpython-313t-x86_64-linux-gnu.so Modules/_sha2.cpython-313t-x86_64-linux-gnu.so Modules/_sha3.cpython-313t-x86_64-linux-gnu.so Modules/_blake2.cpython-313t-x86_64-linux-gnu.so Modules/pyexpat.cpython-313t-x86_64-linux-gnu.so Modules/_elementtree.cpython-313t-x86_64-linux-gnu.so Modules/_codecs_cn.cpython-313t-x86_64-linux-gnu.so Modules/_codecs_hk.cpython-313t-x86_64-linux-gnu.so Modules/_codecs_iso2022.cpython-313t-x86_64-linux-gnu.so Modules/_codecs_jp.cpython-313t-x86_64-linux-gnu.so Modules/_codecs_kr.cpython-313t-x86_64-linux-gnu.so Modules/_codecs_tw.cpython-313t-x86_64-linux-gnu.so Modules/_multibytecodec.cpython-313t-x86_64-linux-gnu.so Modules/unicodedata.cpython-313t-x86_64-linux-gnu.so Modules/fcntl.cpython-313t-x86_64-linux-gnu.so Modules/grp.cpython-313t-x86_64-linux-gnu.so Modules/mmap.cpython-313t-x86_64-linux-gnu.so Modules/_posixsubprocess.cpython-313t-x86_64-linux-gnu.so Modules/resource.cpython-313t-x86_64-linux-gnu.so Modules/select.cpython-313t-x86_64-linux-gnu.so Modules/_socket.cpython-313t-x86_64-linux-gnu.so Modules/syslog.cpython-313t-x86_64-linux-gnu.so Modules/termios.cpython-313t-x86_64-linux-gnu.so Modules/_posixshmem.cpython-313t-x86_64-linux-gnu.so Modules/_multiprocessing.cpython-313t-x86_64-linux-gnu.so Modules/_ctypes.cpython-313t-x86_64-linux-gnu.so Modules/_curses.cpython-313t-x86_64-linux-gnu.so Modules/_curses_panel.cpython-313t-x86_64-linux-gnu.so Modules/_sqlite3.cpython-313t-x86_64-linux-gnu.so Modules/_ssl.cpython-313t-x86_64-linux-gnu.so Modules/_hashlib.cpython-313t-x86_64-linux-gnu.so Modules/_uuid.cpython-313t-x86_64-linux-gnu.so Modules/xxsubtype.cpython-313t-x86_64-linux-gnu.so Modules/_xxtestfuzz.cpython-313t-x86_64-linux-gnu.so Modules/_testbuffer.cpython-313t-x86_64-linux-gnu.so Modules/_testinternalcapi.cpython-313t-x86_64-linux-gnu.so Modules/_testcapi.cpython-313t-x86_64-linux-gnu.so Modules/_testclinic.cpython-313t-x86_64-linux-gnu.so Modules/_testclinic_limited.cpython-313t-x86_64-linux-gnu.so Modules/_testimportmultiple.cpython-313t-x86_64-linux-gnu.so Modules/_testmultiphase.cpython-313t-x86_64-linux-gnu.so Modules/_testsinglephase.cpython-313t-x86_64-linux-gnu.so Modules/_ctypes_test.cpython-313t-x86_64-linux-gnu.so Modules/xxlimited.cpython-313t-x86_64-linux-gnu.so Modules/xxlimited_35.cpython-313t-x86_64-linux-gnu.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl',
    'SHLIB_SUFFIX': '.so',
